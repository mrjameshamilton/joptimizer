...
public class BooleanFieldInliner implements Optimization {
    private static final Matcher<ClassDesc> javaLangBoolean =
            e -> e.equals(ClassDesc.of("java.lang.Boolean"));
    private static final Matcher<String> trueOrFalseField =
            e -> e.equals("TRUE") || e.equals("FALSE");
    private static final Matcher<String> booleanValueMethod = e -> e.equals("booleanValue");
    private static final Matcher<MethodTypeDesc> booleanValueMethodTypeDesc =
            e -> e.equals(MethodTypeDesc.ofDescriptor("()Z"));
