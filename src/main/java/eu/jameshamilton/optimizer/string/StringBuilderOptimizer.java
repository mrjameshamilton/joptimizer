...
public class StringBuilderOptimizer implements Optimization {
    ...
    private static final Matcher<MethodTypeDesc> stringConstructor =
            e -> e.equals(MethodTypeDesc.ofDescriptor("(Ljava/lang/String;)V"));
    ...
    public boolean apply(CodeBuilder codeBuilder, Window window) {
        ...
        var stringBuilderOrBufferClass =
                new Capture<ClassDesc>().and(stringBufferClass.or(stringBuilderClass));
        ...
        if (window.matches(
                ...
                invokespecial(
                        stringBuilderOrBufferClass,
                        constructor,
                        defaultConstructor.or(stringConstructor)))) {
